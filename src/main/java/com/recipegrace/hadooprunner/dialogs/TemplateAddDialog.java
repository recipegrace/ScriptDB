 ...
 */
public class TemplateAddDialog extends Dialog<Template> {


    private boolean editMode = false;

    public TemplateAddDialog() {
    ...
    public TemplateAddDialog(Template template) {
        this.editMode = true;
...
// Create the txtTemplateName and btnTemplateLocation labels and fields.
        GridPane grid = getTemplateGridPane();
